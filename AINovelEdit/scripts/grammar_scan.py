...
превращая «проверить всю главу на морфологию и управление» (273 абзаца)
...
update_merged.py после правок), поэтому проверка идёт построчно по
EN-якорю абзаца.
