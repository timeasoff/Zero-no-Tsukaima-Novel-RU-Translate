...
Перечисли найденные файлы и номера абзацев ДО правки: решение
...
- Число и порядок абзацев — alignment-инвариант EN: при правке
  внутри абзаца (перенос строки, тире, курсив) абзац не разбивать
  и не склеивать; сверка — scripts/check_alignment.py.
...
- Журнал (output/_log/vNN-log.md): отдельная запись на каждый
  пункт — решение, затронутые файлы, абзацы, что именно изменено.
